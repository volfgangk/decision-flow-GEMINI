...
const TEMPLATES = [
  ...
  { id: 2, title: '프로젝트명', icon: <Zap      className="w-3.5 h-3.5 text-orange-500" />, bgColor: 'bg-[#FFE4B5]' },
  { id: 3, title: '워크샵 일정',icon: <Calendar className="w-3.5 h-3.5 text-purple-500" />, bgColor: 'bg-[#E6D7FF]' },
  { id: 4, title: '회의 개선',  icon: <Users    className="w-3.5 h-3.5 text-blue-500"   />, bgColor: 'bg-[#D6E4FF]' },
];
